...
{
	private static final long serialVersionUID = 1849999455;
	public Clinico(String nombre, String apellido, String dni, String domicilio, String ciudad, String telefono, double sueldoBase)
	{
